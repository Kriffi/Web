...
class __TwigTemplate_402057a921ed83aa6909e7535a98c93f extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Importing into the current server");
    ...
    {
        return new Source("", "server/import/index.twig", "C:\\OSPanel\\home\\my.local\\templates\\server\\import\\index.twig");
    }
}
